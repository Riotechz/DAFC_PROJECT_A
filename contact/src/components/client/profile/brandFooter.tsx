        ...
        <>
            <div className="px-4 py-4 font-main">
                <div className="justify-center mx-auto my-5 w-[127px] h-auto">
                    <Image className="flex justify-center mx-auto my-5 w-[127px] h-auto" src={dafcLogo} alt="DAFC" width={127} height={26} />
                </div>
